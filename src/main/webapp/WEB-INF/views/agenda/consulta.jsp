		...
		<table class="table table-hover table-sm mt-4">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="/projetoweb01/editar-compromissos?id=${item.idCompromisso}" class="btn btn-primary btn-sm">
							Editar
						</a>
						<a href="/projetoweb01/excluir-compromisso?id=${item.idCompromisso}" onclick="return confirm('Deseja realmente excluir o compromisso ${item.nome} ? ')" class="btn btn-danger btn-sm">
							Excluir
						</a>
					</td>
				</tr>
