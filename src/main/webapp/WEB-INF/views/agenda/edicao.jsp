		...
		<input type="hidden" name="idCompromisso" value="${compromisso.idCompromisso}" />
			...
			<div class="row mb-3">
				<div class="col-md-6">
					...
					<input type="text" name="nome" class="form-control" placeholder="Digite aqui" required="required" value="${compromisso.nome}"/>
				</div>
				<div class="col-md-3">
					<label>Data do compromisso:</label>
					<input type="date" name="data" class="form-control" required="required" value='<fmt:formatDate value="${compromisso.data}" pattern="yyyy-MM-dd" />' />
				</div>
				<div class="col-md-3">
					<label>Hora do compromisso:</label>
					<input type="time" name="hora" class="form-control" required="required" value="${compromisso.hora}" />
				</div>
			</div>
